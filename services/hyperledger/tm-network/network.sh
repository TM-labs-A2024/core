...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cfssl" ]; then
    ...
    peer_cert peer peer0.org1.tmlabs.com org1
    peer_cert admin Admin@org1.tmlabs.com org1

    infoln "Creating Org2 Identities"
    #function_name cert-type   CN   org
    peer_cert peer peer0.org2.tmlabs.com org2
    peer_cert admin Admin@org2.tmlabs.com org2
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.tmlabs.com docker_peer0.org1.tmlabs.com docker_peer0.org2.tmlabs.com
